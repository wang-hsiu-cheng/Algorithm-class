...
n = np.arange(data_numbers[1], data_numbers[data_columns - 2])  # n from 1 to 100
n1 = np.arange(50, data_numbers[data_columns - 2]/100)
O_n = n / 1000000000
O_log_n = np.log2(n) / 1000000000
O_n_log_n = (n) * np.log2(n) / 1000000000
O_n2 = (n1**2) / 1000000000
...
plt.plot(n1, O_n2, color="C3", label=r"$O(n^2)$", linestyle="--", linewidth=3)
# plt.plot(n, O_n3, color="C4", label=r"$O(n^3)$", linestyle="--", linewidth=3)
plt.title('Avg Time of Finding MST (log-log scale)', fontsize=14)
